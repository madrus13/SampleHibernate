...
@Entity
@Table(name = "strategyeventtype", schema = "mydb", catalog = "")
public class StrategyeventtypeEntity {
    private int id;
    ...
    public boolean equals(Object o) {
        ...
        StrategyeventtypeEntity that = (StrategyeventtypeEntity) o;
    ...
    @OneToMany(mappedBy = "strategyeventtypeByEventType")
